...
import { usersApi } from '@/lib/store';
import { ROLE_LABELS } from '@/lib/mockData';
import { formatDate } from '@/lib/utils';
import { useAuth } from '@/contexts/AuthContext';

function UserModal({ open, onClose, initial, onSaved }) {
  const [form, setForm] = useState(initial || { username: '', password: '', full_name: '', role: 'technician', phone: '' });
  React.useEffect(() => { setForm(initial || { username: '', password: '', full_name: '', role: 'technician', phone: '' }); }, [initial, open]);
    ...
    <div className="space-y-6 animate-fade-in" data-testid="users-page">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-3xl font-bold tracking-tight">Kelola User</h1>
